...
<!-- AUTO-SYNC-START -->
> 🤖 *Auto-synced by `scripts/sync_context.py` at 2026-05-21 20:19 UTC*
...
| **FreqAI identifier** | `finbuddy_v23_zscore_1779274507` | Active model key |
| **Whitelist** | 37 pairs | Binance USDT-M perpetuals |
| **Regime** | ⚖️ NEUTRAL | From HMM (updates every 4h) |
| **Open trades** | 0 (0L / 0S) | Live positions |
| **Closed trades** | 309 | All-time P&L: 99.62 USDT |
| **Last training** | 0m ago | Age of most recent 'Done training' log event |
| **Walk-forward** | ❌ FAIL — WR 37.5%, Sharpe -9.77, DD 6.0%, PF 0.61 (403 trades, run `FinBuddyFreqAI_v23_2025-05-01_2026-05-01_20260520T185326`) | OOS validator — gates Phase 10 |
