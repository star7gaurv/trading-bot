...
<!-- AUTO-SYNC-START -->
> 🤖 *Auto-synced by `scripts/sync_context.py` at 2026-08-10 04:00 UTC*
...
| **Closed trades** | 1063 | All-time P&L: -8.25 USDT |
| **Last training** | unknown | Age of most recent 'Done training' log event |
| **Walk-forward** | ❌ FAIL — WR 0.0%, Sharpe 0.00, DD 0.0%, PF 0.00 (0 trades, run `FinBuddyFreqAI_v23_2026-01-01_2026-08-01_20260809T220001`) | OOS validator — gates Phase 10 |
