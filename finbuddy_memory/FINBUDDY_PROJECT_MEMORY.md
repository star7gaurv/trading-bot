...
**Status**: 🔴🟢 v23 LIVE on **1h** (`finbuddy_v23_mom_features_1788780906` — 2026-09-07, added multi-day BTC momentum features; previous `finbuddy_v23_tf1h_1782044602`) · LT=0.7/ST=−0.6 · K_TP=3.0/K_SL=3.5 · DI+SVM disabled · **edge gate ACTIVE (new entries paused)** — WF fail streak 205 as of 2026-09-10, unchanged in kind since 2026-09-07; `scripts/edge_monitor.py` pauses new entries automatically until it recovers (open trades still exit normally) · pairs trading's own reversion gate ALSO active since 2026-09-10 (same philosophy) · grid trading is the one module with a genuinely positive paper track record (+71.75 USDT, 21W/5L) · family model cache active  
**Last Updated**: 2026-09-10 UTC — built the full MkDocs documentation site (auto-generated API/cron/third-party/coverage reference, Shopify-dev-docs-style layout), shipped a pairs-trading reversion gate, fixed the arbitrage feed daemon (never installed to systemd since July). Full detail: CLAUDE.md 2026-09-10 session entry + auto-memory `project_20260910_docs_site.md` / `project_20260910_paper_modules_deep_dive.md`.
...
<!-- AUTO-SYNC-START -->
> 🤖 *Auto-synced by `scripts/sync_context.py` at 2026-09-12 12:00 UTC*
...
| **FreqAI identifier** | `finbuddy_v23_mom_features_1788780906` | Active model key |
| **Whitelist** | 25 pairs | Binance USDT-M perpetuals |
| **Regime** | 🐂 BULL | From HMM (updates every 4h) |
| **Open trades** | 0 (0L / 0S) | Live positions |
| **Closed trades** | 1204 | All-time P&L: -37.72 USDT |
| **Last training** | 21m ago | Age of most recent 'Done training' log event |
| **Walk-forward** | ❌ FAIL — WR 46.9%, Sharpe -4.73, DD 8.0%, PF 0.61 (307 trades, run `FinBuddyFreqAI_v23_2026-02-01_2026-09-01_20260901T130001`) | OOS validator — gates Phase 10 |
