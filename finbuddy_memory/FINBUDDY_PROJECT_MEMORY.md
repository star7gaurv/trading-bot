...
<!-- AUTO-SYNC-START -->
> 🤖 *Auto-synced by `scripts/sync_context.py` at 2026-08-27 16:00 UTC*
...
| **Closed trades** | 1153 | All-time P&L: -6.99 USDT |
| **Last training** | unknown | Age of most recent 'Done training' log event |
| **Walk-forward** | ❌ FAIL — WR 47.3%, Sharpe -5.66, DD 11.3%, PF 0.61 (336 trades, run `FinBuddyFreqAI_v23_2026-01-01_2026-08-01_20260827T130002`) | OOS validator — gates Phase 10 |
