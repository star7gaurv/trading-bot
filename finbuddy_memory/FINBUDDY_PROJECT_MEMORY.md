...
<!-- AUTO-SYNC-START -->
> 🤖 *Auto-synced by `scripts/sync_context.py` at 2026-05-21 00:00 UTC*
...
| **FreqAI identifier** | `finbuddy_v23_sym_1779274506` | Active model key |
| **Whitelist** | 25 pairs | Binance USDT-M perpetuals |
| **Regime** | ⚖️ NEUTRAL | From HMM (updates every 4h) |
| **Open trades** | 1 (1L / 0S) | Live positions |
| **Closed trades** | 301 | All-time P&L: 116.47 USDT |
| **Last training** | 55m ago | Age of most recent 'Done training' log event |
| **Walk-forward** | ⏳ Running — 1/21 folds done (FinBuddyFreqAI_v23_2025-05-01_2026-05-01_20260520T185326) | OOS validator — gates Phase 10 |
