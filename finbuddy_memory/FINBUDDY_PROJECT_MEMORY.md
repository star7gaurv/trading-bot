...
<!-- AUTO-SYNC-START -->
> 🤖 *Auto-synced by `scripts/sync_context.py` at 2026-08-27 04:00 UTC*
...
| **Closed trades** | 1153 | All-time P&L: -8.88 USDT |
| **Last training** | unknown | Age of most recent 'Done training' log event |
| **Walk-forward** | ❌ FAIL — WR 47.4%, Sharpe -5.00, DD 10.3%, PF 0.64 (331 trades, run `FinBuddyFreqAI_v23_2026-01-01_2026-08-01_20260826T220001`) | OOS validator — gates Phase 10 |
