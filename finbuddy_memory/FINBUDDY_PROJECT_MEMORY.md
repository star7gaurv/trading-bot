...
<!-- AUTO-SYNC-START -->
> 🤖 *Auto-synced by `scripts/sync_context.py` at 2026-05-25 00:00 UTC*
...
| **FreqAI identifier** | `finbuddy_v23_oi_delta_1779570511` | Active model key |
| **Whitelist** | 26 pairs | Binance USDT-M perpetuals |
| **Regime** | ⚖️ NEUTRAL | From HMM (updates every 4h) |
| **Open trades** | 0 (0L / 0S) | Live positions |
| **Closed trades** | 356 | All-time P&L: 86.19 USDT |
| **Last training** | unknown | Age of most recent 'Done training' log event |
| **Walk-forward** | ⏳ Running — 0/21 folds (FinBuddyFreqAI_v23_2025-10-01_2026-05-01_20260524T220002) | OOS validator — gates Phase 10 |
