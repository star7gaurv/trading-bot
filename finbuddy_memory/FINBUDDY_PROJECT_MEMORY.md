...
<!-- AUTO-SYNC-START -->
> 🤖 *Auto-synced by `scripts/sync_context.py` at 2026-08-31 04:00 UTC*
...
| **Closed trades** | 1159 | All-time P&L: -17.02 USDT |
| **Last training** | unknown | Age of most recent 'Done training' log event |
| **Walk-forward** | ❌ FAIL — WR 47.1%, Sharpe -5.79, DD 11.5%, PF 0.61 (340 trades, run `FinBuddyFreqAI_v23_2026-01-01_2026-08-01_20260830T220001`) | OOS validator — gates Phase 10 |
