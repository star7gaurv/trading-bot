...
<!-- AUTO-SYNC-START -->
> 🤖 *Auto-synced by `scripts/sync_context.py` at 2026-09-17 12:00 UTC*
...
| **Open trades** | 2 (2L / 0S) | Live positions |
| **Closed trades** | 1208 | All-time P&L: -36.58 USDT |
...
### Standing product rule — customer transparency and usability (2026-09-17)

For every new feature, fix, service, automation, or model change, explicitly review what customers should see. Surface useful status, evidence quality, data freshness, costs, assumptions, limitations, failure states, and recovery actions in plain language. Preserve progressive disclosure: lead with the decision-relevant summary, keep technical detail available but secondary, never hide uncertainty, and never overload the main workflow. Dashboard/API/documentation work is part of feature completion, not optional polish.
