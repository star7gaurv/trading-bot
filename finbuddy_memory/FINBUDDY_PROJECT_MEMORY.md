...
<!-- AUTO-SYNC-START -->
> 🤖 *Auto-synced by `scripts/sync_context.py` at 2026-05-17 00:00 UTC*
...
| **Closed trades** | 206 | All-time P&L: 106.12 USDT |
| **Last training** | 193m ago | Age of most recent 'Done training' log event |
