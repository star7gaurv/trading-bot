...
<!-- AUTO-SYNC-START -->
> 🤖 *Auto-synced by `scripts/sync_context.py` at 2026-05-29 20:00 UTC*
...
| **FreqAI identifier** | `finbuddy_v23_promoted_1779997908` | Active model key |
| **Whitelist** | 26 pairs | Binance USDT-M perpetuals |
| **Regime** | ⚖️ NEUTRAL | From HMM (updates every 4h) |
| **Open trades** | 0 (0L / 0S) | Live positions |
| **Closed trades** | 450 | All-time P&L: 50.23 USDT |
| **Last training** | 147m ago | Age of most recent 'Done training' log event |
| **Walk-forward** | ❌ FAIL — WR 0.0%, Sharpe 0.00, DD 0.0%, PF 0.00 (0 trades, run `FinBuddyFreqAI_v23_2025-12-01_2026-05-01_20260528T220002`) | OOS validator — gates Phase 10 |
