...
<!-- AUTO-SYNC-START -->
> 🤖 *Auto-synced by `scripts/sync_context.py` at 2026-06-06 20:00 UTC*
...
| **FreqAI identifier** | `finbuddy_v23_nosvm_1780729988` | Active model key |
| **Whitelist** | 26 pairs | Binance USDT-M perpetuals |
| **Regime** | ⚖️ NEUTRAL | From HMM (updates every 4h) |
| **Open trades** | 1 (0L / 1S) | Live positions |
| **Closed trades** | 485 | All-time P&L: 41.03 USDT |
| **Last training** | 36m ago | Age of most recent 'Done training' log event |
| **Walk-forward** | ❌ FAIL — WR 0.0%, Sharpe 0.00, DD 0.0%, PF 0.00 (0 trades, run `FinBuddyFreqAI_v23_2026-01-01_2026-06-01_20260603T220001`) | OOS validator — gates Phase 10 |
