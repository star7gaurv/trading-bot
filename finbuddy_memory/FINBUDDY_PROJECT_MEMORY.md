...
<!-- AUTO-SYNC-START -->
> 🤖 *Auto-synced by `scripts/sync_context.py` at 2026-06-01 04:00 UTC*
...
| **Closed trades** | 473 | All-time P&L: 45.06 USDT |
| **Last training** | unknown | Age of most recent 'Done training' log event |
| **Walk-forward** | ❌ FAIL — WR 0.0%, Sharpe 0.00, DD 0.0%, PF 0.00 (0 trades, run `FinBuddyFreqAI_v23_2025-12-01_2026-05-01_20260531T220001`) | OOS validator — gates Phase 10 |
