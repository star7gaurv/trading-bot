# Cortexa Signal Contract v1

**Status:** Draft — not yet implemented
**Last updated:** 2026-04-21
**Owner:** Gaurav

The signal contract is the public API between Cortexa's **signal generator** (the brain) and its **trade executor** (the hands). Every trading decision flows through this JSON structure. Once an executor accepts a signal, the signal's fields determine exactly what happens.
